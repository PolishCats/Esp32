...
echo "   1) Demo mode (sin login): http://localhost:3000/dashboard.html?demo=1"
echo "   2) Modo autenticado: inicia sesión con $USERNAME y abre http://localhost:3000/dashboard.html"
